...
func TestMergeMessages(t *testing.T) {
	Convey("Given responses with different messages", t, func() {
		...
		mergedResponses, err := qlutils.MergeResponses(
			response1, response2)
		So(err, ShouldBeNil)
...
func TestMergeResponses(t *testing.T) {
	...
	Convey("Given 3 responses with 2 results each", t, func() {
		...
		mergedResponse, err := qlutils.MergeResponses(
		...
		Convey("Given at least one response with an error", func() {
			...
			mergedResponse, err := qlutils.MergeResponses(response1, response2, response3)
			So(err, ShouldBeNil)
		...
		Convey("Given at least one response has partial = true", func() {
			...
			_, err := qlutils.MergeResponses(response1, response2, response3)

			Convey("MergeResponses returns error", func() {
